qx.Class.define("turismo.comp.windowGenerarPresupuesto",
{
	...
	*/
	...
	var uploader = new com.zenesis.qx.upload.UploadMgr(btnSeleccionarPresupuesto, "services/UploadMgr/server/php.php");
	...
	var commandModificarContactar = new qx.ui.command.Command("Enter");
