qx.Class.define("sacdiag.comp.windowAcercaDe",
{
	...
	composite.add(new qx.ui.basic.Label("SACD - Sistema de Alta Complejidad Diagnóstica"), {flex: 1});
	...
	composite.add(new qx.ui.basic.Label("Versión 1.0 - Año 2018"), {flex: 1});
	composite.add(new qx.ui.basic.Label("-"), {flex: 1});
	...
	composite.add(new qx.ui.basic.Label("Juán M. Granda - insulae@gmail.com"), {flex: 1});
