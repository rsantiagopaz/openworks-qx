...
class class_Base
{
  ...
  public function auditoria($sql, $seccion) {
	...
	$sql = "INSERT auditoria SET id_usuario='" . $_SESSION['login']->usuario . "', fecha=NOW(), sql_ejecutado='" . $this->mysqli->real_escape_string($sql) . "', ip='" . $this->getRealIP() . "', seccion='" . $seccion . "'";
