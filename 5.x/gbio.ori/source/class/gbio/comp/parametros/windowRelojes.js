qx.Class.define("gbio.comp.parametros.windowRelojes",
{
	...
	commandAgregar.addListener("execute", function(e){
		...
		tableModel.addRowsAsMapArray([{id_reloj: "0", descrip: "Nuevo reloj", host: "", alta: true}], null, true);
	...
	var btnAgregar = new qx.ui.menu.Button("Agregar reloj", null, commandAgregar);
	...
	menu.memorizar();
		...
		tableModel.setColumns(["Descripción", "Host"], ["descrip", "host"]);
		...
		btnAceptar.addListener("execute", function(e){
			...
			if (enviar) {
				...
				try {
					var resultado = rpc.callSync("escribir_relojes", p);
				} catch (ex) {
