...
$factura = array(
     ...
     'punto_vta' => 4000,
     'tipo_cbte' => 6,              // 1: FCA, 2: NDA, 3:NCA, 6: FCB, 11: FCC
     ...
     'tipo_doc' => 99,              // 96: DNI, 80: CUIT, 99: Consumidor Final
...
$json = file_put_contents($p . 'entrada.json', json_encode(array($factura)));
...
//$e = exec("python ./rece1.py rece.ini /json /ult 1 4000", $o, $r);

$json = file_put_contents('f.bat', "@ echo off" . "\n" . "cd \\pyafipws-master" . "\n" . "rece1.py /json /ult 6 4000");
$e = exec("f.bat", $o, $r);
echo $r, "<br>";
echo implode("<br>", $o);
echo "<br><br><br>";
...
$json = file_get_contents($p . 'salida.json');
...
//exec("python ./rece1.py rece.ini /json", $o);
$json = file_put_contents('f.bat', "@ echo off" . "\n" . "cd \\pyafipws-master" . "\n" . "rece1.py /json");
$e = exec("f.bat", $o, $r);
...
//exec("python ./pyfepdf.py rece.ini --cargar --json", $o)
$json = file_put_contents('f.bat', "@ echo off" . "\n" . "cd \\pyafipws-master" . "\n" . "pyfepdf.py --cargar --json");
$e = exec("f.bat", $o, $r);
