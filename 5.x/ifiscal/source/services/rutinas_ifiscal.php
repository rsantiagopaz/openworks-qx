...
FUNCTION ConfigureControllerByOne($byVar1, $strVar2)
{
 ...
 $nError = "ConfigureControllerByOne" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
...
FUNCTION GetPrinterVersion()
{
 ...
 $nError = "GetPrinterVersion" . $sp . $nError;
 return ($nError);
}
//***************************************************************
...
FUNCTION DailyCloseByNumber($nVar1, $nVar2, $byVar3)
{
 ...
 $nError = "DailyCloseByNumber" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// GetDailyReport()
...
FUNCTION OpenFiscalReceipt($byVar1, $byVar2)
{
 ...
 $nError = "OpenFiscalReceipt" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// PrintFiscalText()
...
FUNCTION PrintFiscalText($strVar1, $byVar2)
{
 ...
 $nError = "PrintFiscalText" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// ReceiptText()
...
//		ReceiptText($strVar1);
// Prop�sito:
//		Imprimir texto recibo
// Argumentos: 
//		strVar1	Texto fiscal
// Devuelve:
//		0 si no hay error y != 0 si hay un error
//******************************************************************************
                        ...
                        $byVar7, $byVar8)
{
 ...
 $nError = "PrintLineItem" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// PrintLineItem2()
...
FUNCTION GeneralDiscount($strVar1, $dblVar2, $byVar3, $byVar4, $byVar5)
{
 ...
 $nError = "GeneralDiscount" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// ReturnRecharge()
...
FUNCTION Perceptions($strVar1, $strVar2, $dblVar3)
{
 ...
 $strBuff= chr(96) . $sp . $strVar1 . $sp . $strVar2 . $sp . number_format($dblVar3, 2, ".", "");	
...
FUNCTION CloseFiscalReceipt()
{
 ...
 $nError = "CloseFiscalReceipt" . $sp . $nError;
 return ($nError);
}
//***************************************************************
...
FUNCTION SetHeaderTrailer($nVar1, $strVar2)
{
 ...
 $nError = "SetHeaderTrailer" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// GetHeaderTrailer()
...
FUNCTION SetCustomerData($strVar1, $strVar2, $byVar3, $byVar4, $strVar5 = null)
{
 ...
 $nError = "SetCustomerData" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// SetFantasyName()
...
FUNCTION SetEmbarkNumber($byVar1, $strVar2)
{
 ...
 $nError = "SetEmbarkNumber" . $sp . $nError;
 return ($nError);
}
//*******************************************************************************
// GetEmbarkNumber()
