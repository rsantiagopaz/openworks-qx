qx.Class.define("componente.comp.ui.ramon.table.tableParametro",
{
	...
	commandAgregar.addListener("execute", function(e){
		if (win == null) {
			...
			var listenerAceptado = win.addListener("aceptado", function(e){
				var data = e.getData();
			...
			win.addListenerOnce("close", function(e){
				win.removeListenerById(listenerAceptado);
			});
