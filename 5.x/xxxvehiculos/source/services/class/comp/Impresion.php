...
case "general" : {
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td align="center" colspan="6"><big>Estado General <?php echo date("Y-m-d H:i:s"); ?></big></td></tr>
	<tr><td>&nbsp;</td></tr>
	...
	foreach ($resultado->gral as $item) {
		...
		<td><?php echo ((bool) $item->asunto) ? "En trámite" : ""; ?>&nbsp;</td>
		<td><?php echo ((bool) $item->diferido) ? "En trámite" : ""; ?>&nbsp;</td>
		</tr>
		<?php
		
		if ($item->estado == "T") {
			$sql = "SELECT movimiento.*, razones_sociales.razon_social AS taller FROM movimiento INNER JOIN `019`.razones_sociales USING(cod_razon_social) WHERE id_entsal=" . $item->id_entsal . " AND movimiento.estado='E' ORDER BY f_ent DESC";
			$rs = mysql_query($sql);
...
case "historial" : {
	...
	$sql = "SELECT * FROM entsal WHERE id_vehiculo=" . $rowVehiculo->id_vehiculo . " ORDER BY f_ent DESC";
...
case "salida_vehiculo" : {
	...
	<tr><td align="center" colspan="6"><big><b>Ministerio de Salud y Desarrollo Social</b></big></td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td align="center" colspan="6"><big>Formulario de Conformidad</big></td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td><b>Salida de vehiculo: <?php echo $rowEntsal->nro_patente . "  " . $rowEntsal->marca; ?></b></td><td>Fecha: <?php echo $rowEntsal->f_sal; ?></td><td>Km: <?php echo $rowEntsal->kilo; ?></td></tr>
	...
	while ($rowMovimiento = mysql_fetch_object($rsMovimiento)) {
		?>
		<tr><td colspan="2"><?php echo $rowMovimiento->taller; ?></td><td colspan="2">Km: <?php echo $rowMovimiento->kilo; ?></td></tr>
		<tr><td colspan="20">
	...
	<tr><td>Firma entrega vehiculo</td></tr>
	</td></tr>
	</table>
	</body>
	</html>
...
case "entrada_taller" : {
	...
	<?php
		...
		?>
		<tr><td align="center" colspan="6"><big><b>ORDEN DE TRABAJO Nro. <?php echo $_REQUEST['id_movimiento']; ?></b></big></td></tr>
		<tr><td>&nbsp;</td></tr>
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td>_____________________________</td><td>_____________________________</td></tr>
	<tr><td>Firma usuario</td><td>Firma jefe taller</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>_____________________________</td></tr>
