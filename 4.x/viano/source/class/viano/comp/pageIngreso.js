qx.Class.define("viano.comp.pageIngreso",
{
	...
	tableModel.setColumns(["Fecha", "Origen", "Detalle"], ["fecha", "lugar", "descrip"]);
	...
	selectionModel.addListener("changeSelection", function(){
		if (! selectionModel.isSelectionEmpty()) {
			...
			}, "leer_ingreso_item", {id_ingreso: rowData.id_ingreso});
		}
	});
	...
	var rpc = new qx.io.remote.Rpc("services/", "comp.Parametros");
	try {
		var resultado = rpc.callSync("leer_ingreso");
	} catch (ex) {
