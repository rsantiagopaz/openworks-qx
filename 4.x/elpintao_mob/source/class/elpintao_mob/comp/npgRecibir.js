qx.Class.define("elpintao_mob.comp.npgRecibir",
{
  ...
  members : 
  {
	...
	list.addListener("changeSelection", function(e) {
		...
		var r = new qx.ui.mobile.form.renderer.SinglePlaceholder(form);
		r.addCssClass("group");
		...
		dialog.setHideOnBlockerTap(true);
		...
		this.application.routing.onGet("/recibir_pedido/dialog", function(e){
			this.show();
		}, dialog);
		
		//dialog.show();
		this.application.routing.executeGet("/recibir_pedido/dialog");
