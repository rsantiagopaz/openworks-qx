...
/**
 * This is the main application class of your custom application "p_mob"
 *
 * @asset(p_mob/*)
 */
qx.Class.define("p_mob.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      var login = new p_mob.page.Login();
      var overview = new p_mob.page.Overview();
