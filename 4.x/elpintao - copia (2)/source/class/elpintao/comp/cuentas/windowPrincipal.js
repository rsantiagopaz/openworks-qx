...
slbSucursal.addListener("changeSelection", function(e){
	...
	try {
		var resultado = rpc.callSync("leer_cuentas", p);
	} catch (ex) {
...
tbl.addListener("cellDbltap", function(e){
	...
	var menu1 = new componente.comp.ui.ramon.menu.Menu();
...
var vtUbicacion = new componente.comp.ui.ramon.tree.VirtualTree();
