...
*/	
	...
	btnGenerarPedExt.addListener("execute", function(e){
		var win = new elpintao.comp.pedidos.windowPedExt("Generar pedido a proveedor - " + slbFabrica.getSelection()[0].getLabel());
	...
	btnRecibirPedExt.addListener("execute", function(e) {
		...
		if (! rowData.recibido) {
			...
			parametro.label = "Pedido a proveedor: " + rowData.fecha + " - " + rowData.fabrica;
