qx.Class.define("elpintao.comp.productos.compositeVisorHistoricoPrecio",
{
	...
	var functionLeer_historico = function(rowItem) {
		...
		var rpc = new qx.io.remote.Rpc("../../services/", "comp.elpintao.ramon.Historico_precio");
		try {
	...
	var menuPlot = new componente.comp.ui.ramon.menu.Menu();
	...
	var menuItem = new componente.comp.ui.ramon.menu.Menu();

	var commandAgregarItem = new qx.ui.core.Command("Insert");
	commandAgregarItem.addListener("execute", function(e){
		var win = new componente.comp.elpintao.ramon.historico_precio.windowProducto("Agregar item");
	...
	var commandEliminarItem = new qx.ui.core.Command("Del");
  ...
  // Obtain the behavior object to manipulate
	...
	this.add(tblItem, {left: 0, top: 0, right: "60.2%", bottom: "75%"});
		...
		var tblDatos = new componente.comp.ui.ramon.table.Table(tableModelDatos, custom);
