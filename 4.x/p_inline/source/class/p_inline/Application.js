...
/**
 * This is the main application class of your custom application "p_inline"
 *
 * @asset(p_inline/*)
 */
qx.Class.define("p_inline.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      // Create a button
      var button1 = new qx.ui.form.Button("First Button", "p_inline/test.png");
