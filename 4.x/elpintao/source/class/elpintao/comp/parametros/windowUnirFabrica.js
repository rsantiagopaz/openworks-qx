qx.Class.define("elpintao.comp.parametros.windowUnirFabrica",
{
	...
	*/
	...
	/*
	var cboOrigen = new componente.comp.ui.ramon.combobox.ComboBoxAuto("services/", "comp.Reparacion", "autocompletarFabrica");
	...
	*/
	...
	/*
	var cboDestino = new componente.comp.ui.ramon.combobox.ComboBoxAuto("services/", "comp.Reparacion", "autocompletarFabrica");
	...
	*/
	...
	var tblOrigen = new componente.comp.ui.ramon.table.Table(tableModelOrigen, custom);
	...
	var tblDestino = new componente.comp.ui.ramon.table.Table(tableModelDestino, custom);
