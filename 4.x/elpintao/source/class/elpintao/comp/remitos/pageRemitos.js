qx.Class.define("elpintao.comp.remitos.pageRemitos",
{
	...
	var functionActualizar = this.functionActualizar = qx.lang.Function.bind(function(id_remito) {
		...
		this.timerId = timer.start(function(userData, timerId) {
			...
			this.rpc = new componente.comp.io.ramon.rpc.Rpc("services/", "comp.Remitos");
	...
	/*
	var cboSucursal = new componente.comp.ui.ramon.combobox.ComboBoxAuto("services/", "comp.Reparacion", "autocompletarSucursal", null, 2);
	...
	*/
	...
	var menutblRemito = new componente.comp.ui.ramon.menu.Menu();
	...
	menutblRemito.memorizar();
		...
		var tblRemito = new componente.comp.ui.ramon.table.Table(tableModel, custom);
	...
	var tblTotgen = new componente.comp.ui.ramon.table.Table(tableModelTotgen, custom);
	...
	var tblTotales = new componente.comp.ui.ramon.table.Table(tableModelTotales, custom);
	//tblTotales.toggleShowCellFocusIndicator();
