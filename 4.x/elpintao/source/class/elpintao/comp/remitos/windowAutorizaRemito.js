qx.Class.define("elpintao.comp.remitos.windowAutorizaRemito",
{
	...
	var cboAutoriza = new componente.comp.ui.ramon.combobox.ComboBoxAuto("services/", "comp.Remitos", "autocompletarUsuario", null, 1);
	...
	var cboTransporta = new componente.comp.ui.ramon.combobox.ComboBoxAuto("services/", "comp.Remitos", "autocompletarUsuario", null, 1);
