qx.Class.define("componente.comp.elpintao.ramon.productos.compositeProductos",
{
	...
	btnEditarStock.addListener("execute", function(e) {
		var id_producto = tableModel.getRowData(tbl.getFocusedRow()).id_producto;
		var win = new componente.comp.elpintao.ramon.productos.windowStock(nodoActual.get("id_arbol"), id_producto, nodoActual.get("clasificacion"));
		win.addListener("aceptado", function(e){
			bandera_id_producto = id_producto;
  ...
  // Obtain the behavior object to manipulate
	...
	menutblPaciente.addAt(new componente.comp.elpintao.ramon.parametros.menubuttonOrdenamiento(tbl, "pageProductos"), 3);
